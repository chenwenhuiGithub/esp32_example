...
#define EXAMPLE_UDP_MULTICAST_IP        "225.10.100.200"
#define EXAMPLE_UDP_MULTICAST_PORT      60001
...
static void udp_server_task(void *pvParameters)
{
    ...
    local_addr.sin_port = htons(EXAMPLE_UDP_MULTICAST_PORT);
    ...
    imreq.imr_multiaddr.s_addr = inet_addr(EXAMPLE_UDP_MULTICAST_IP);
    ...
    ESP_LOGI(TAG, "udp multicast server listen, %s:%u", EXAMPLE_UDP_MULTICAST_IP, EXAMPLE_UDP_MULTICAST_PORT);
    while (1) {
