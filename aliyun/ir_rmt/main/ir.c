...
static ir_rmt_info_t rmt_infos[RMTID_MAX] = {
    {
        RMTID_TV, {
            {CHANNELID_0,           {0x65, 0x4C, 0xBA, 0x45}},
            {CHANNELID_1,           {0x65, 0x4C, 0xFE, 0x01}},
            {CHANNELID_2,           {0x65, 0x4C, 0xFD, 0x02}},
            {CHANNELID_3,           {0x65, 0x4C, 0xFC, 0x03}},
            {CHANNELID_4,           {0x65, 0x4C, 0xFB, 0x04}},
            {CHANNELID_5,           {0x65, 0x4C, 0xFA, 0x05}},
            {CHANNELID_6,           {0x65, 0x4C, 0xF9, 0x06}},
            {CHANNELID_7,           {0x65, 0x4C, 0xF8, 0x07}},
            {CHANNELID_8,           {0x65, 0x4C, 0xF7, 0x08}},
            {CHANNELID_9,           {0x65, 0x4C, 0xF6, 0x09}},
            {CHANNELID_UP,          {0x65, 0x4C, 0xF4, 0x0B}},
            {CHANNELID_DOWN,        {0x65, 0x4C, 0xF1, 0x0E}},
            {CHANNELID_LEFT,        {0x65, 0x4C, 0xEF, 0x10}},
            {CHANNELID_RIGHT,       {0x65, 0x4C, 0xEE, 0x11}},
            {CHANNELID_OK,          {0x65, 0x4C, 0xF2, 0x0D}},
            {CHANNELID_VOLUME_ADD,  {0x65, 0x4C, 0xEA, 0x15}},
            {CHANNELID_VOLUME_SUB,  {0x65, 0x4C, 0xE3, 0x1C}},
            {CHANNELID_CHANNEL_ADD, {0x65, 0x4C, 0xE0, 0x1F}},
            {CHANNELID_CHANNEL_SUB, {0x65, 0x4C, 0xE1, 0x1E}},
            {CHANNELID_POWER,       {0x65, 0x4C, 0xF5, 0x0A}},
            {CHANNELID_HOME,        {0x65, 0x4C, 0xE9, 0x16}},
            {CHANNELID_SIGNAL,      {0x65, 0x4C, 0xF3, 0x0C}},
            {CHANNELID_MUTE,        {0x65, 0x4C, 0xF0, 0x0F}},
            {CHANNELID_BACK,        {0x65, 0x4C, 0xE2, 0x1D}},
            {CHANNELID_MENU,        {0x65, 0x4C, 0xC8, 0x37}},
            {CHANNELID_SETTING,     {0x65, 0x4C, 0xFF, 0x00}}
        }
    },
    {
        RMTID_SETTOPBOX, {
            {CHANNELID_0,           {0xDD, 0x22, 0x78, 0x87}},
            {CHANNELID_1,           {0xDD, 0x22, 0x6D, 0x92}},
            {CHANNELID_2,           {0xDD, 0x22, 0x6C, 0x93}},
            {CHANNELID_3,           {0xDD, 0x22, 0x33, 0xCC}},
            {CHANNELID_4,           {0xDD, 0x22, 0x71, 0x8E}},
            {CHANNELID_5,           {0xDD, 0x22, 0x70, 0x8F}},
            {CHANNELID_6,           {0xDD, 0x22, 0x37, 0xC8}},
            {CHANNELID_7,           {0xDD, 0x22, 0x75, 0x8A}},
            {CHANNELID_8,           {0xDD, 0x22, 0x74, 0x8B}},
            {CHANNELID_9,           {0xDD, 0x22, 0x3B, 0xC4}},
            {CHANNELID_UP,          {0xDD, 0x22, 0x35, 0xCA}},
            {CHANNELID_DOWN,        {0xDD, 0x22, 0x2D, 0xD2}},
            {CHANNELID_LEFT,        {0xDD, 0x22, 0x66, 0x99}},
            {CHANNELID_RIGHT,       {0xDD, 0x22, 0x3E, 0xC1}},
            {CHANNELID_OK,          {0xDD, 0x22, 0x31, 0xCE}},
            {CHANNELID_VOLUME_ADD,  {0xDD, 0x22, 0x7F, 0x80}},
            {CHANNELID_VOLUME_SUB,  {0xDD, 0x22, 0x7E, 0x81}},
            {CHANNELID_CHANNEL_ADD, {0xDD, 0x22, 0x7A, 0x85}},
            {CHANNELID_CHANNEL_SUB, {0xDD, 0x22, 0x79, 0x86}},
            {CHANNELID_POWER,       {0xDD, 0x22, 0x23, 0xDC}},
            {CHANNELID_HOME,        {0xDD, 0x22, 0x77, 0x88}},
            {CHANNELID_SIGNAL,      {0x65, 0x4C, 0xF3, 0x0C}},
            {CHANNELID_MUTE,        {0xDD, 0x22, 0x63, 0x9C}},
            {CHANNELID_BACK,        {0xDD, 0x22, 0x6A, 0x95}},
            {CHANNELID_MENU,        {0xDD, 0x22, 0x7D, 0x82}},
            {CHANNELID_SETTING,     {0xDD, 0x22, 0x72, 0x8D}}
        }
    }, 
    {
        RMTID_LIGHT_BEDROOM, {
            {CHANNELID_VOLUME_ADD,  {0xFF, 0x00, 0xBF, 0x40}},
            {CHANNELID_VOLUME_SUB,  {0xFF, 0x00, 0xE6, 0x19}},
            {CHANNELID_POWER,       {0xFF, 0x00, 0xF2, 0x0D}}
        }
    }
};
...
static esp_err_t nec_encoder_create()
{
...
{
    return (signal_duration < (spec_duration + NEC_DECODE_MARGIN_DURATION)) &&
           (signal_duration > (spec_duration - NEC_DECODE_MARGIN_DURATION));
}

static bool nec_parse_logic0(rmt_symbol_word_t *rmt_nec_symbols)
{
    return nec_check_in_range(rmt_nec_symbols->duration0, NEC_DATA_ZERO_DURATION_0) &&
           nec_check_in_range(rmt_nec_symbols->duration1, NEC_DATA_ZERO_DURATION_1);
}

static bool nec_parse_logic1(rmt_symbol_word_t *rmt_nec_symbols)
{
    return nec_check_in_range(rmt_nec_symbols->duration0, NEC_DATA_ONE_DURATION_0) &&
           nec_check_in_range(rmt_nec_symbols->duration1, NEC_DATA_ONE_DURATION_1);
}

static void nec_frame_parse(rmt_symbol_word_t *rmt_nec_symbols, uint32_t symbol_num)
{
    uint32_t i = 0, j = 0;
    ...
    for (i = 0; i < symbol_num; i++) {
        ESP_LOGI(TAG, "%02lu: {%u:%u},{%u:%u}", i, rmt_nec_symbols[i].level0, rmt_nec_symbols[i].duration0, rmt_nec_symbols[i].level1, rmt_nec_symbols[i].duration1);
    }
        ...
        for (i = 0; i < NEC_FRAME_LEN; i++) {
            for (j = 0; i < 8; j++) {
                if (nec_parse_logic1(rmt_nec_symbols)) {
                    ...
                    ESP_LOGE(TAG, "invalid symbol, %lu %lu", i, j);
                    return;
                }
                rmt_nec_symbols++;
            }            
        }
        ESP_LOGI(TAG, "NEC frame: %02X %02X %02X %02X", frame[0], frame[1], frame[2], frame[3]);
    } else {
...
static void nec_recv_task(void* parameter) {
...
void ir_init() {
    rmt_rx_channel_config_t rx_channel_cfg = {
        ...
        .gpio_num = CONFIG_IR_RX_GPIO_NUM,
    };
    rmt_tx_channel_config_t tx_channel_cfg = {
        ...
        .mem_block_symbols = 64,
        .trans_queue_depth = 4,
        .gpio_num = CONFIG_IR_TX_GPIO_NUM,
    };
    ...
    nec_encoder_create();
    xTaskCreate(nec_recv_task, "nec_recv_task", 1024, NULL, 1, NULL);
}
